...
static void _str_to_hex(const uint8_t * const in, const int inlen, char * const out) {
...
static void _prep_logs(const _output_dnssim_request_t * const req, const core_object_payload_t * const ans, char out_qrylog[], char out_anslog[], const int out_bufsize) {

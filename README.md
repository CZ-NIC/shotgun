...
Realistic DNS benchmarking tool which supports UDP, TCP, DNS-over-TLS and
DNS-over-HTTPS. This tool is capable of establishing hundreds of thousands of
connections, which is useful to simulate real traffic over stateful protocols.
